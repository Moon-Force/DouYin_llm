...
const successEvent = {
  ...
  processing_status: {
    ...
    extracted_memory_texts: ["likes tonkotsu ramen"],
    memory_recall_attempted: true,
    memory_recalled: true,
    recalled_memory_ids: ["mem-9"],
    recalled_memory_texts: ["likes ramen", "cannot eat spicy food"],
...
assert.deepEqual(getCommentProcessingDetails(successEvent), [
  ...
  },
  {
    ...
    meta: [
      ...
      { key: "feed.processing.extractedMemoryPreview", value: "likes tonkotsu ramen" },
    ],
  },
  {
    key: "memoryRecalled",
    ...
    meta: [
      ...
      { key: "feed.processing.recalledMemoryPreview", value: "likes ramen / cannot eat spicy food" },
    ],
  },
  {
    key: "suggestionGenerated",
